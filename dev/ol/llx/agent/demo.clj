(ns ol.llx.agent.demo
  (:require
   ...
   [ol.llx.ai.impl.oauth.openai-codex-jvm :as openai-codex-jvm]
...
(defn make-oauth-api-key-resolver
  "Returns an `ol.llx.agent` `:get-api-key` callback backed by local OAuth creds."
...
(comment
  ;; Evaluate in REPL:
  ;; (require '[ol.llx.agent.demo :as demo] :reload)
