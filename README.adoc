...
image:https://ci.outskirtslabs.com/repos/github/outskirtslabs/llx/badge.svg[alt=nixbot,link=https://ci.outskirtslabs.com/repos/github/outskirtslabs/llx]
...
----
;; deps.edn
{:deps {com.outskirtslabs/llx
        {:git/url "https://github.com/outskirtslabs/llx.git"
         :git/sha "ea558cd4fbc9518cd7a23bddc380c303fed549d1"}}}
----
...
* link:examples/minimal-coding-agent/README.md[Example: Minimal Coding Agent]
