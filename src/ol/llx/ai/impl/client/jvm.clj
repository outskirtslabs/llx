...
(>defn- start-jvm-source!
        ...
        [:ol.llx/runtime-start-source-input => :ol.llx/runtime-start-source-result]
        (schema/assert-valid! :ol.llx/runtime-start-source-input input)
...
(>defn run-stream!
       ...
       [:ol.llx/runtime-run-stream-base-input => :ol.llx/runtime-run-stream-result]
       (let [response*      (atom nil)
         ...
         (schema/assert-valid! :ol.llx/runtime-run-stream-result runtime-result)))
