(ns ol.llx.ai
  (:require
   ...
   [ol.llx.ai.impl.models :as impl.models]
   [ol.llx.ai.impl.schema :as impl.schema]
   [ol.llx.ai.impl.utils.overflow :as impl.overflow]
   [ol.llx.ai.impl.utils.tool-validation :as impl.tool-validation]
   [ol.llx.ai.impl.utils.unicode :as impl.unicode]))

(defn default-env
  "Returns the default environment for your platform."
  []
  #?(:cljd (throw (ex-info "CLJS support not yet implemented" {:type :ol.llx/env-required}))
