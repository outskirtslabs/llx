...
(defn- fixture-path [name]
  (str "test/llx_ai/fixtures/model_catalog/" name))
...
(deftest build-catalog-normalizes-supported-providers-only
  (let [build-catalog (resolve-public 'llx-ai.model-catalog.generate/build-catalog)]
...
(deftest render-generated-source-is-stable
  (let [build-catalog (resolve-public 'llx-ai.model-catalog.generate/build-catalog)
        render-source (resolve-public 'llx-ai.model-catalog.generate/render-generated-source)]
    (is (ifn? build-catalog))
    ...
    (when (and (ifn? build-catalog)
      ...
      (let [catalog  (build-catalog {:models-dev-data (load-models-dev-fixture)
        ...
        (is (str/includes? rendered "(ns llx-ai.models-generated"))))))
