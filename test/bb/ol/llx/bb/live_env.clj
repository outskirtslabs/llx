(ns ol.llx.bb.live-env
  (:require
   [clojure.java.io :as io]
   [clojure.string :as str]))

(def provider-services
  {"OLLAMA_API_KEY"    :ol.llx/ollama
   "OPENAI_API_KEY"    :ol.llx/openai
   "ANTHROPIC_API_KEY" :ol.llx/anthropic
   "GEMINI_API_KEY"    :ol.llx/google
   "MISTRAL_API_KEY"   :ol.llx/mistral})
