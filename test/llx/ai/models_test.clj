...
(deftest model-registry-and-lookup
  (let [get-model     (resolve-public 'llx.ai.impl.models/get-model)
        get-models    (resolve-public 'llx.ai.impl.models/get-models)
        get-providers (resolve-public 'llx.ai.impl.models/get-providers)]
...
(deftest model-utility-functions
  (testing "calculate-cost"
    (let [calculate-cost (resolve-public 'llx.ai.impl.models/calculate-cost)]
  ...
  (testing "supports-xhigh?"
    (let [supports-xhigh? (resolve-public 'llx.ai.impl.models/supports-xhigh?)]
  ...
  (testing "models-equal?"
    (let [models-equal? (resolve-public 'llx.ai.impl.models/models-equal?)]
      (is (ifn? models-equal?))
