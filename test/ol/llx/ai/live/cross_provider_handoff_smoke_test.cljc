(ns ol.llx.ai.live.cross-provider-handoff-smoke-test
  (:require
...
(deftest ^{:ol.llx/openai true :ol.llx/anthropic true} live-handoff-anthropic-to-openai
  (util/async done
              (util/run-live-async!
               (handoff-check!*
...
(deftest ^{:ol.llx/openai true :ol.llx/anthropic true} live-handoff-openai-responses-to-anthropic
  (util/async done
              (util/run-live-async!
               (handoff-check!*
...
(deftest ^{:ol.llx/openai true :ol.llx/anthropic true} live-handoff-anthropic-to-openai-responses
  (util/async done
              (util/run-live-async!
               (handoff-check!*
                models/anthropic {:max-output-tokens 96}
...
(deftest ^:ol.llx/openai live-handoff-openai-responses-to-openai-completions
  (util/async done
              (util/run-live-async!
               (handoff-check!*
                models/openai-responses {:max-output-tokens 128
...
(deftest ^{:ol.llx/anthropic true :ol.llx/google true} live-handoff-anthropic-to-google
  (util/async done
              (util/run-live-async!
               (handoff-check!*
                models/anthropic {:max-output-tokens 96}
...
(deftest ^{:ol.llx/google true :ol.llx/openai true} live-handoff-google-to-openai-completions
  (util/async done
              (util/run-live-async!
               (handoff-check!*
...
(deftest ^{:ol.llx/google true :ol.llx/mistral true} live-handoff-google-to-mistral
  (util/async done
              (util/run-live-async!
               (handoff-check!*
                models/google {:max-output-tokens 96
...
(deftest ^{:ol.llx/mistral true :ol.llx/ollama true} live-handoff-mistral-to-ollama
  (util/async done
              (util/run-live-async!
               (handoff-check!*
