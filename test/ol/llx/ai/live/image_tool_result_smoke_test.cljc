(ns ol.llx.ai.live.image-tool-result-smoke-test
  (:require
...
(def ^:private test-image-base64
  (util/read-file-base64 "test/ol/llx/ai/fixtures/test-image.png"))
...
(deftest ^:ol.llx/openai live-image-tool-result-openai-completions
  (util/async done
              (util/run-live-async!
               (run-image-suite!* models/openai-completions {})
               done)))

(deftest ^:ol.llx/openai live-image-tool-result-openai-responses
  (util/async done
              (util/run-live-async!
               (run-image-suite!* models/openai-responses {})
               done)))

(deftest ^:ol.llx/anthropic live-image-tool-result-anthropic
  (util/async done
              (util/run-live-async!
