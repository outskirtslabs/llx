(ns ol.llx.ai.adapters.google-generative-ai-test
  (:require
   #?@(:clj [[clojure.test :refer [deftest is testing]]]
       :cljs [[cljs.test :refer-macros [async deftest is testing]]
              [promesa.core :as p]])
   [clojure.string :as str]
   [ol.llx.ai.impl.adapters.google-generative-ai :as sut]
...
(defn- fixture
  [name]
  (util/read-edn-file (str "test/ol/llx/ai/fixtures/google/" name ".edn")))
