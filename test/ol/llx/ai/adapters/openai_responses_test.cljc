(ns ol.llx.ai.adapters.openai-responses-test
  (:require
   #?@(:clj [[clojure.test :refer [deftest is testing]]]
       :cljs [[cljs.test :refer-macros [deftest is testing]]])
   [clojure.string :as str]
   [ol.llx.ai.impl.adapters.openai-responses :as sut]
...
(defn- fixture
  [name]
  (util/read-edn-file (str "test/ol/llx/ai/fixtures/openai_responses/" name ".edn")))
