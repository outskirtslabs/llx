(ns ol.llx.ai.adapters.anthropic-messages-test
  (:require
   #?@(:clj [[clojure.test :refer [deftest is]]]
       :cljs [[cljs.test :refer-macros [deftest is]]])
   [clojure.string :as str]
   [ol.llx.ai.impl.adapters.anthropic-messages :as sut]
...
(defn- fixture
  [name]
  (util/read-edn-file (str "test/ol/llx/ai/fixtures/anthropic/" name ".edn")))
