...
This unified API is exposed under the entrypoints `llx.ai/complete` and `llx.ai/stream` and the default choice for most callers. 
If you need provider-specific options, `llx.ai/complete*` and `llx.ai/stream*` let you work directly with them.
